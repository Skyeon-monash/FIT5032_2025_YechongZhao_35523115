  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :style="author.name === 'George Orwell' ? { fontWeight: 'bold', color: '#1c3e50' } : {}"
        >
    ...
    <section class="lab-section">
      ...
      <p>
        ...
        <strong>{{ bookstores.companyName }}</strong>
      </p>
      ...
      <p>We operate in:</p>
      <ul>
        <li v-for="(bookName, index) in bookstores.topSellers" :key="index">
          {{ bookName }}
        </li>
      </ul>
      <p>Our #1 seller:</p>
...
import authors from '@/assets/json/authors'
import bookstores from '@/assets/json/bookstores'
...
const austen = computed(() => authors.find((author) => author.id === 2))
</script>
